...
/**
 * REST controller for managing {@link co.za.bankx.domain.Contact}.
 */
@RestController
...
public class ContactResource {
    ...
    public List<Contact> getAllContacts(@RequestParam(name = "filter", required = false) String filter) {
        if ("clientinfo-is-null".equals(filter)) {
            log.debug("REST request to get all Contacts where clientInfo is null");
            return contactService.findAllWhereClientInfoIsNull();
        }
